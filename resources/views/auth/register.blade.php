        ...
        <main class="w-full h-full min-h-screen flex flex-col justify-center items-center p-6 relative">
            ...
            <div class="w-full max-w-lg relative z-10">
                ...
                <div class="bg-[#0a0a0a] border border-white/5 p-8 md:p-10 relative overflow-hidden animate-entry delay-200 shadow-2xl">
                    ...
                    <form action="{{ route('register.submit') }}" method="POST" class="space-y-5 relative z-10">
                        @csrf
                        ...
                        @error('password') <p class="text-red-500 text-[10px] uppercase font-bold mt-1 tracking-wide">{{ $message }}</p> @enderror
                ...
                <div class="mt-8 text-center animate-entry delay-300">
                    <p class="text-gray-500 text-xs uppercase tracking-wide">
                        ...
                        <a href="{{ route('login') }}" class="text-white font-bold hover:text-blue-400 border-b border-white/20 hover:border-blue-400 transition ml-1 pb-0.5">Sign In</a>
                    </p>
                </div>
            </div>
