...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-8 text-center animate-entry delay-300">
                    <p class="text-gray-500 text-xs uppercase tracking-wide">
                        New here? 
                        <a href="<?php echo e(route('register')); ?>" class="text-white font-bold hover:text-blue-400 border-b border-white/20 hover:border-blue-400 transition ml-1 pb-0.5">Create Account</a>
                    </p>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\ASUS\OneDrive\Desktop\laravel\ecommerce-store\resources\views/auth/login.blade.php ENDPATH**/ ?>