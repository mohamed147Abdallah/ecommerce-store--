        ...
        <main class="flex-1 md:ml-24 relative min-h-screen flex flex-col">
            ...
            <div class="flex-1 max-w-4xl mx-auto w-full px-6 py-12 md:py-20">
                ...
                <div class="bg-[#0a0a0a] border border-white/5 p-8 md:p-12 relative overflow-hidden animate-entry delay-300">
                    ...
                    <form action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8 relative z-10">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="group">
                            ...
                            <input type="text" name="name" placeholder="E.G. NEON RUNNER V2" value="<?php echo e(old('name')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="group">
                                ...
                                <input type="number" step="0.01" name="price" placeholder="0.00" value="<?php echo e(old('price')); ?>"
                                       class="w-full bg-neutral-900 border border-white/10 px-6 py-4 text-white text-sm font-bold placeholder-gray-700 focus:outline-none focus:border-white focus:bg-black transition-all duration-300">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="group">
                                ...
                                <input type="number" name="stock" placeholder="UNITS" value="<?php echo e(old('stock')); ?>"
                                       class="w-full bg-neutral-900 border border-white/10 px-6 py-4 text-white text-sm font-bold placeholder-gray-700 focus:outline-none focus:border-white focus:bg-black transition-all duration-300">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="group">
                            ...
                            <textarea name="description" rows="5" placeholder="ENTER PRODUCT DETAILS..." 
                                      class="w-full bg-neutral-900 border border-white/10 px-6 py-4 text-white text-sm font-bold placeholder-gray-700 focus:outline-none focus:border-white focus:bg-black transition-all duration-300"><?php echo e(old('description')); ?></textarea>
...
</html><?php /**PATH C:\Users\ASUS\OneDrive\Desktop\laravel\ecommerce-store\resources\views/products/create.blade.php ENDPATH**/ ?>