    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <nav class="fixed bottom-0 md:top-0 md:left-0 w-full md:w-24 md:h-screen h-16 glass-strong z-50 flex md:flex-col justify-between items-center py-0 md:py-8 px-6 md:px-0 md:border-r md:border-t-0 border-t border-white/5">
            ...
            <div class="flex md:flex-col justify-around w-full md:w-auto md:gap-10 items-center">
                <a href="<?php echo e(route('home')); ?>" class="text-white hover:text-blue-400 transition-colors duration-300 flex flex-col items-center gap-1 group">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="text-gray-500 hover:text-white transition-colors duration-300 flex flex-col items-center gap-1 group">
        ...
        <main class="flex-1 md:ml-24 pb-20 md:pb-0 relative">
                        ...
                        <div class="bg-[#0a0a0a] border border-white/10 w-full max-w-4xl h-[80vh] flex flex-col rounded-xl overflow-hidden shadow-2xl animate-entry">
                            ...
                            <div class="flex-1 overflow-y-auto p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                                <?php $__currentLoopData = $latestProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div onclick="selectHeroProduct(<?php echo e(json_encode($p)); ?>)" class="cursor-pointer group relative border border-white/5 hover:border-blue-500 transition-all duration-300 rounded-lg overflow-hidden bg-neutral-900">
                                        <img src="<?php echo e($p->image ? asset('storage/'.$p->image) : 'https://via.placeholder.com/400x400'); ?>" class="w-full h-40 object-cover opacity-70 group-hover:opacity-100 transition">
                                        <div class="p-3">
                                            <h5 class="text-white text-xs font-bold truncate"><?php echo e($p->name); ?></h5>
                                            <p class="text-gray-500 text-[10px]">$<?php echo e($p->price); ?></p>
                                        </div>
                    ...
                    <?php if($heroProduct): ?>
                        ...
                        <div class="order-2 lg:order-1 animate-entry delay-100">
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                <a id="hero-link" href="<?php echo e(route('products.show', $heroProduct->id)); ?>" class="px-8 py-3 text-xs font-black uppercase tracking-widest text-white border border-white/20 hover:border-white transition flex items-center gap-2 rounded-full">
                        ...
                        <div class="order-1 lg:order-2 relative animate-entry delay-200 flex justify-center py-10">
                            ...
                            <div class="relative z-10 w-full max-w-sm border border-white/20 bg-[#0a0a0a] rounded-3xl overflow-visible shadow-2xl">
                                ...
                                <!-- The Image -->
                                <a id="hero-image-link" href="<?php echo e(route('products.show', $heroProduct->id)); ?>" class="block w-full h-auto relative overflow-hidden rounded-3xl group">
                                    <img id="hero-image" src="<?php echo e($heroProduct->image ? asset('storage/'.$heroProduct->image) : 'https://via.placeholder.com/800x1000/1a1a1a/333333?text=Product'); ?>" 
                                ...
                                <div class="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-[90%] bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-full p-2 pl-5 pr-2 z-30 shadow-2xl flex justify-between items-center">
                                    <div class="flex flex-col justify-center overflow-hidden">
                                        <p id="bs-card-desc" class="text-[9px] text-blue-400 uppercase tracking-widest leading-tight truncate">
                                            <?php echo e($heroProduct->category->name ?? 'Premium'); ?>

                                        </p>
                                        <div class="flex items-baseline gap-2">
                                             <h4 id="bs-card-name" class="text-white font-bold text-sm tracking-wide truncate max-w-[120px]">
                                                 <?php echo e($heroProduct->name); ?>

                                             </h4>
                                             <span id="bs-card-price" class="text-white/60 text-xs font-medium">
                                                 $<?php echo e($heroProduct->price); ?>

                                             </span>
                                        </div>
                                    </div>
                                    
                                    <form id="bs-card-add-form" action="<?php echo e(route('cart.add', $heroProduct->id)); ?>" method="POST" class="add-to-cart-form shrink-0">
                                        <?php echo csrf_field(); ?>
            ...
            <section class="sticky top-0 z-40 bg-[#050505]/90 backdrop-blur-md border-y border-white/5 py-4 animate-entry delay-300">
                <div class="max-w-[1600px] mx-auto px-6 overflow-x-auto no-scrollbar flex gap-4 md:justify-center">
                    <a href="<?php echo e(route('home')); ?>#shop" 
                       class="whitespace-nowrap px-6 py-2 text-xs font-black uppercase tracking-widest border transition rounded-full <?php echo e(!request('category') ? 'bg-white text-black border-white' : 'border-white/20 text-gray-500 hover:text-white hover:border-white'); ?>">
                       All Items
                    </a>
                    
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('home', ['category' => $category->id])); ?>#shop" 
                           class="whitespace-nowrap px-6 py-2 text-xs font-black uppercase tracking-widest border transition rounded-full <?php echo e(request('category') == $category->id ? 'bg-white text-black border-white' : 'border-white/20 text-gray-500 hover:text-white hover:border-white'); ?>">
                    ...
                    <div class="mb-12 flex items-end justify-between">
                        <div>
                            <h2 class="text-3xl md:text-4xl font-black text-white uppercase tracking-tighter mb-2">
                                <?php echo e($selectedCategory->name ?? 'Category'); ?>
                        ...
                        <div class="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">
                            <?php echo e($filteredProducts->count()); ?> Products
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="col-span-full py-20 text-center border border-dashed border-white/10 rounded-lg">
                                <h3 class="text-xl font-bold text-white mb-2">No Products Found in <?php echo e($selectedCategory->name ?? 'this category'); ?></h3>
                                <p class="text-gray-500 text-sm">Check back later for new arrivals.</p>
                                <a href="<?php echo e(route('home')); ?>#shop" class="inline-block mt-4 text-xs font-bold text-white border-b border-white hover:text-gray-300 transition">View All Products</a>
                            </div>
                        <?php endif; ?>
                    </div>
                            ...
                            <div class="mb-20">
                                ...
                                <div class="flex items-end justify-between mb-8 border-b border-white/10 pb-4">
                                    <div class="flex items-center gap-4">
                                        <h3 class="text-2xl font-black text-white uppercase tracking-tighter"><?php echo e($category->name); ?></h3>
                                        <span class="px-2 py-1 bg-white/10 text-[10px] font-bold text-white rounded"><?php echo e($category->products->count()); ?></span>
                                    </div>
                                    <a href="<?php echo e(route('home', ['category' => $category->id])); ?>#shop" class="text-xs font-bold uppercase text-gray-500 hover:text-white transition flex items-center gap-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12">
                                    <?php $__currentLoopData = $category->products->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="group">
                                            ...
                                            <div>
                                                <p class="text-[10px] text-gray-500 uppercase tracking-widest mb-1">
                                                     <a href="<?php echo e(route('home', ['category' => $category->id])); ?>#shop" class="hover:text-white transition-colors">
                                                         <?php echo e($category->name); ?>
...
</html><?php /**PATH C:\Users\ASUS\OneDrive\Desktop\laravel\ecommerce-store\resources\views/welcome.blade.php ENDPATH**/ ?>