...
<head>
    ...
    <title><?php echo e($product->name); ?> - MyStore</title>
       ...
       <!-- Sidebar Navigation (Static) -->
        ...
        <main class="flex-1 md:ml-24 relative min-h-screen flex flex-col">
            ...
            <div class="flex-1 max-w-[1400px] mx-auto w-full px-6 md:px-12 py-12 md:py-20">
                ...
                <!-- Breadcrumb -->
                <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-white mb-10 transition group animate-entry delay-100">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    <div class="relative bg-[#0a0a0a] border border-white/5 overflow-hidden group h-[500px] lg:h-[700px] rounded-3xl animate-entry delay-200">
                        ...
                        <img src="<?php echo e($product->image ? asset('storage/'.$product->image) : 'https://via.placeholder.com/800x800/1a1a1a/333333?text=No+Image'); ?>" 
                    ...
                    <div class="flex flex-col justify-center animate-entry delay-300">
                        ...
                        <div class="flex items-center gap-6 mb-10 border-b border-white/10 pb-8">
                            <span class="text-4xl font-bold text-white">$<?php echo e($product->price); ?></span>
                        ...
                        <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST" class="add-to-cart-form mb-12">
                            <?php echo csrf_field(); ?>
                            <button type="submit" 
...
</html><?php /**PATH C:\Users\ASUS\OneDrive\Desktop\laravel\ecommerce-store\resources\views/products/show.blade.php ENDPATH**/ ?>