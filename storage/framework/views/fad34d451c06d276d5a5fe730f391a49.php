    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <main class="flex-1 md:ml-24 relative min-h-screen flex flex-col">
            ...
            <div class="flex-1 max-w-2xl mx-auto w-full px-6 py-12 md:py-24">
                ...
                <!-- Breadcrumb -->
                <a href="<?php echo e(route('products.create')); ?>" class="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-white mb-8 transition group animate-entry delay-100">
                ...
                <div class="bg-[#0a0a0a] border border-white/5 p-8 md:p-12 relative overflow-hidden animate-entry delay-300">
                    ...
                    <form action="<?php echo e(route('categories.store')); ?>" method="POST" class="space-y-8 relative z-10">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <input type="text" name="name" placeholder="E.G. ACCESSORIES" value="<?php echo e(old('name')); ?>"
...
</html><?php /**PATH C:\Users\ASUS\OneDrive\Desktop\laravel\ecommerce-store\resources\views/categories/create.blade.php ENDPATH**/ ?>